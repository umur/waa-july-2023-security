package com.example.springdata1.config;


import com.example.springdata1.filter.JwtFilter;
...
//  String [] roles = {"CLIENT"}; // Try this :)
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/addresses/**").hasAnyAuthority("ADMIN")
                .requestMatchers("/categories/**").hasAnyAuthority("ADMIN")
                .requestMatchers("/reviews/**").hasAnyAuthority("USER")
